...
def insertNodesFromXml(xml_file):
    ...
    try:
        ...
        for node in root.findall('.//node'):
            ...
            cursor.execute("INSERT INTO Nodes (NodeID, X, Y) VALUES (%s, %s, %s)", (node_id, x, y))
...
def insertLinksFromXml(xml_file):
    ...
    try:
        ...
        for link_data in root.findall('.//link'):
            ...
            cursor.execute("INSERT INTO Links (LinkID, FromNode, ToNode, Length, FreeSpeed, Capacity, PermLanes, OneWay, Mode) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                           (link_id, from_node_id, to_node_id, length, freespeed, capacity, permlanes, oneway, modes))
...
def insertEventsFromXml(xml_file):
    ...
    try:
        ...
        for event_data in root.findall('.//event'):
            ...
            cursor.execute("INSERT INTO Events (Time, Type, DepartureID, TransitLineID, Request, ActType, Purpose, Vehicle, Amount, TransactionPartner, TransitRouteID, RelativePosition, VehicleID, TaskIndex, NetworkMode, Mode, Distance, DriverID, X, Y, Agent, DestinationStop, DvrpMode, Facility, TaskType, LegMode, Person, Delay, AtStop, Link, DvrpVehicle) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);",
                        (time, event_type, departure_id, transit_line_id, request, act_type, purpose, vehicle, amount, transaction_partner, transit_route_id, relative_position, vehicle_id, task_index, network_mode, mode, distance, driver_id, x, y, agent, destination_stop, dvrp_mode, facility, task_type, leg_mode, person, delay, at_stop, link_id, dvrp_vehicle))
